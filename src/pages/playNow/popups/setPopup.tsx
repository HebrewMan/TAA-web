...
const SetPopup = (props:any)=>{
    ...
    const langBtn = {logo:downSvg,text:'English',font:'16px',outerColor:'#D38F5B',shadowColor:'#FFD28E',height:34,width:120};
    ...
    const setMusicSwitchHandle = ()=>{
        ...
        setBtnColors(
            ...
            {outerColor:'#A02424',shadowColor:'linear-gradient(0deg, #D64F4F, #D64F4F), #BAD60F'}
        )
    }
        ...
        <React.Fragment>
            <div className='share-popup set-popup' style={{height:'260px'}}>
                ...
                <div className="switch" style={{marginTop:'32px'}}>
                    ...
                    <img src={musicSvg} className='music-logo' width={38} height={38} alt="" style={{ transform: `translateX(${position}px)` }} onClick={setMusicSwitchHandle}/>
                </div>
